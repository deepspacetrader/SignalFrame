...
export function LocalAIRequiredModal({ isOpen, onClose }: LocalAIRequiredModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-[#0a0c10] border border-white/10 w-full max-w-2xl shadow-2xl overflow-hidden relative" onClick={e => e.stopPropagation()}>
                {/* Header */}
                <div className="p-6 border-b border-white/10 flex justify-between items-center bg-gradient-to-r from-accent-primary/10 to-transparent">
                    <h2 className="text-xl font-display font-bold text-white flex items-center gap-3">
                        <span className="w-2 h-6 bg-accent-primary"></span>
                ...
                <div className="p-8 max-h-[70vh] overflow-y-auto">
                    {!isLocalhost ? (
                        <div className="space-y-6">
                            <div className="bg-accent-primary/5 border border-accent-primary/20 p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-4 font-mono text-xs bg-black/50 p-4 border border-white/10">
                                ...
                                <div className="flex gap-3 pt-2">
                                    <a
                                        ...
                                        className="flex-1 py-3 bg-white text-black font-bold text-center hover:bg-slate-200 transition-colors flex items-center justify-center gap-2 rounded"
                                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white/5 p-6 border border-white/10 space-y-4">
                                ...
                                <div className="pl-8">
                                    <div className="bg-black/40 p-3 font-mono text-xs text-emerald-400 border border-white/5 flex justify-between items-center group">
                            ...
                            <div className="bg-white/5 p-6 border border-white/10 space-y-4">
                                ...
                                <div className="pl-8 space-y-2">
                                    <div className="bg-black/40 p-3 font-mono text-xs text-blue-300 border border-white/5">
                                        OLLAMA_ORIGINS="*"<br/>
                                    ...
                                    <div className="mt-4 pl-4 animate-in slide-in-from-top-2">
                                        <div className="flex gap-2">
                                            <input
                                                ...
                                                className="flex-1 bg-black/40 border border-white/10 px-3 py-2 text-xs text-white focus:border-accent-primary outline-none"
                                            />
                                            <button
