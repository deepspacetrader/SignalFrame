...
export function SectionRegenerateButton({ label = 'Regenerate', className = '', onClick, ...props }: SectionRegenerateButtonProps) {
  ...
  const paletteClasses = 'bg-white/5 border-white/10 text-white/80 hover:bg-accent-primary hover:text-white disabled:opacity-50 disabled:cursor-not-allowed'
